...
all_data = {
    'Trial 1': np.array(
        [[8.698, -9.613], [7.172, -2.594], [3.51, -5.951], [8.087, -2.899], [5.035, -2.289],
...
mgr.set_data_and_params(all_data, hz=hz, channel_names=['ch1', 'ch2'],
...
mgr.set_segmenter(pep.processors.Segmenter(),
                  all_beg_ts={'Trial 1': 0, 'Trial 2': 0},
                  all_end_ts={'Trial 1': 0.018, 'Trial 2': 999})
